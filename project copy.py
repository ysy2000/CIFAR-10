...
import reader
import neuralnet_part1 as p1 ## 가져옴
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lrate', dest="lrate", type = float, default=0.01, 
                        help='Learning rate(you can change in 3e-4)')
